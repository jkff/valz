                    ...
                    if( setMethod != null ) {
                        ...
                        if( types.length == 1 ) {
                            ...
                            if( value instanceof Map ) {
                                setMethod.invoke( target, convert( value, findClassName( (Map)value, getTargetClass( resolveParameterizedTypes( paramType, value.getClass())) ) ) );
                            } else {
                                setMethod.invoke( target, convert( value, resolveParameterizedTypes( paramType, value.getClass() ) ) );
                            }
